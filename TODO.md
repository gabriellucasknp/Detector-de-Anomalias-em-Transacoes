# TODO - Detector de Anomalias em Transações Financeiras
...
### Deploy AWS
- [x] deploy/Dockerfile.prod (multi-stage)
- [x] deploy/ecs-task-definition.json (ECS Fargate)
- [x] deploy/terraform/main.tf (VPC, ECS, RDS, ECR, ALB, CloudWatch)
- [x] deploy/terraform/variables.tf
- [x] deploy/terraform/outputs.tf
- [x] deploy/terraform/terraform.tfvars.example
